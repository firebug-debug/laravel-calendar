...
namespace Trace\CarbonCalendar;
...
class CarbonCalendar
{
     ...
     * @var array
     */
    protected $lunarMonthAlias = ['正', '二', '三', '四', '五', '六', '七', '八', '九', '十', '冬', '腊'];
     ...
     * @var array
     */
    protected $monthAlias = ['一', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二'];
    ...
    public function toChinaMonth(int $month): string
    {
        ...
        return $this->lunarMonthAlias[abs($month) - 1] . '月';
    }
